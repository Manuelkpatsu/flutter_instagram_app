...
import 'package:instagram_app/screens/components/comment/comment_tile.dart';
import 'package:instagram_app/screens/constants/strings.dart';
import 'package:instagram_app/screens/extensions/dismiss_keyboard.dart';
...
import 'package:instagram_app/state/comments/providers/post_comments_provider.dart';
...
class PostCommentsScreen extends HookConsumerWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed:
                hasText.value ? () => _submitCommentWithController(commentController, ref) : null,
          ),
        ],
      ),
      body: SafeArea(
  ...
  Future<void> _submitCommentWithController(TextEditingController controller, WidgetRef ref) async {
