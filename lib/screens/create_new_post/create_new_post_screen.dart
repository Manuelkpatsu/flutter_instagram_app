...
import 'package:instagram_app/screens/components/file_thumbnail_view.dart';
...
import 'package:instagram_app/state/post_settings/models/post_setting.dart';
import 'package:instagram_app/state/post_settings/providers/post_settings_provider.dart';

class CreateNewPostScreen extends StatefulHookConsumerWidget {
...
class _CreateNewPostViewState extends ConsumerState<CreateNewPostScreen> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: TextField(
                decoration: const InputDecoration(labelText: Strings.pleaseWriteYourMessageHere),
                autofocus: true,
                maxLines: null,
