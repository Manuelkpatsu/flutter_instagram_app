  ...
  Future<bool> deletePost({required Post post}) async {
    try {
      ...
      await _deleteAllDocuments(
          inCollection: FireStoreCollectionName.comments, postId: post.postId);

      // delete all likes associated with this post
      await _deleteAllDocuments(inCollection: FireStoreCollectionName.likes, postId: post.postId);
