...
import 'package:instagram_app/state/image_upload/constants/constants.dart';
...
import 'package:instagram_app/state/posts/models/post_payload.dart';
...
class ImageUploadNotifier extends StateNotifier<IsLoading> {
  ...
  Future<bool> upload({
    ...
    final thumbnailRef = FirebaseStorage.instance
        .ref()
        .child(userId)
        .child(FireStoreCollectionName.thumbnails)
        .child(fileName);
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection(FireStoreCollectionName.posts).add(postPayload);
      return true;
    } catch (_) {
      return false;
    } finally {
