import 'package:instagram_app/state/post_settings/constants/strings.dart';
...
enum PostSetting {
  ...
  const PostSetting({required this.title, required this.description, required this.storageKey});
}
